...
namespace Network
{
	public class Message
	{
		...
		{
			return (EMessageType)IPAddress.NetworkToHostOrder(BitConverter.ToInt32(_data[..4], 0));
		}

		public string Arg()
		{
			return Encoding.UTF8.GetString(_data, NetworkManager.MsgTypeSize, NetworkManager.MsgArgSize)
				.TrimEnd('\0');
		}
	}
}