...
namespace UI
{
	...
	{
		[Header("ActionInfo")] [SerializeField]
		private ActionData defaultStateAction;
	...
	{
		[Header("State")] public EuiState targetState;

		[Header("Transform")] public Vector2 position;

		public Vector2 size;
		public Vector3 scale;

		[Header("Active")] public bool setActive;
	}
}